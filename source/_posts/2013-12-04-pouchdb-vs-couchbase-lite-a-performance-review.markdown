...
{% img https://s3.amazonaws.com/zeMirco/github/pouchdb-vs-couchbase/bulk-add.png bulk add documents  %}
...
{% img https://s3.amazonaws.com/zeMirco/github/pouchdb-vs-couchbase/query-via-view.png query via view document  %}
